...
const Chatbot = () => {
  ...
  return (
    <div>
      <button
        className="fixed bottom-4 right-4 inline-flex items-center justify-center text-sm font-medium border rounded-full w-16 h-16 bg-black hover:bg-gray-700 cursor-pointer border-gray-200 p-0 normal-case"
          ...
          <div className="pr-4 h-[474px] overflow-y-auto">
            ...
            {isLoading && (
              <div className="flex gap-3 my-4 text-gray-600 text-sm">
                <p className="p-2 rounded-lg bg-gray-200">AI is thinking...</p>
              </div>
            )}
          </div>
